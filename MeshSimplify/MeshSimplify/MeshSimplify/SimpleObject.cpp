...
namespace SimpleOBJ
{
    ...
    bool CSimpleObject::Parse(FILE* fp)
    {
		...
		while(fscanf_s(fp, "%s", buf,_countof(buf)) != EOF)
        {
            lineNumber ++;
            switch(buf[0])
            {
            ...
            case 'f':				/* face */
                {
                    ...
                    if(fscanf_s(fp, "%s", buf,_countof(buf))!=1)
                    {
                    ...
                    {
                        /* v//n */
                        if( sscanf_s(buf, "%d//%d", &vIndices[0],&n) ==2  &&
                            fscanf_s(fp, "%d//%d", &vIndices[1], &n) ==2  &&
                            fscanf_s(fp, "%d//%d", &vIndices[2], &n) ==2)
                        {
                            nTriangles++;
                    ...
                    else if (sscanf_s(buf, "%d/%d/%d", &v, &t, &n) == 3)
                    {
                        /* v/t/n */
                        vIndices[0] = v;
                        if( fscanf_s(fp, "%d/%d/%d", &vIndices[1], &t, &n) ==3 &&
                            fscanf_s(fp, "%d/%d/%d", &vIndices[2], &t, &n) ==3 )
                        {
                            nTriangles++;
                            vecTriangles.push_back(vIndices);
                        }
                    ...
                    else if (sscanf_s(buf, "%d/%d", &v, &t) == 2)
                    {
                        /* v/t */
                        vIndices[0] = v;
                        if( fscanf_s(fp, "%d/%d", &vIndices[1], &t) ==2 &&
                            fscanf_s(fp, "%d/%d", &vIndices[2], &t) ==2 )
                        {
                            nTriangles++;
                            vecTriangles.push_back(vIndices);
                        }
                    ...
                    {
                        /* v */
                        if( sscanf_s(buf, "%d", &vIndices[0]) ==1 && 
                            fscanf_s(fp, "%d", &vIndices[1])  ==1 &&
                            fscanf_s(fp, "%d", &vIndices[2])  ==1 )
                        {
                            nTriangles++;
                            vecTriangles.push_back(vIndices);
                        }
